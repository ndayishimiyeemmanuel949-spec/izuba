 ...
 */
export type ResolveProp<P> = P extends Selector<infer T> ? T : P extends AccessorChain<infer T> ? T : P extends GetSet<infer T> ? T : P extends Bind ? any : P extends Tpl ? string : P extends Expr ? any : P;
/**
...
export type RecordAlias = string | {
    toString(): string;
};
