...
export class ContainerBase extends Widget {
    init(context) {
        ...
        this.items = [];
        if (this.layout) {
            let layout = Container.create(this.layout, { items });
            layout.init(context);
            this.layout = null;
...
export class StyledContainerBase extends ContainerBase {
}
StyledContainerBase.prototype.styled = true;
// Closed type for direct usage
export class StyledContainer extends StyledContainerBase {
}
