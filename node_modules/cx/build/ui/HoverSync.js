...
import { PureContainerBase } from "./PureContainer";
import { VDOM } from "./VDOM";
export class HoverSync extends PureContainerBase {
    constructor(config) {
        super(config);
    }
...
export function withHoverSync(key, hoverSync, hoverChannel, hoverId, render) {
    ...
    return (_jsx(HoverSyncChild, { hoverSync: hoverSync, hoverChannel: hoverChannel, hoverId: hoverId, render: render }, key));
}
