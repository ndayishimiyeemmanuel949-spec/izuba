...
import { PureContainer, PureContainerBase } from "./PureContainer";
...
export class Restate extends PureContainerBase {
    declareData(...args) {
    ...
    init() {
        ...
        delete this.layout;
        if (this.useParentLayout == null)
            this.useParentLayout = !this.detached;
        super.init();
    }
    ...
    explore(context, instance) {
        ...
        if (instance.cache("cultureInfo", instance.culture))
            instance.markShouldUpdate();
