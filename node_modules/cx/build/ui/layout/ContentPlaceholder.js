...
export class ContentPlaceholderInstance extends Instance {
    unregisterContentPlaceholder;
}
export class ContentPlaceholder extends PureContainerBase {
    declareData(...args) {
        ...
        if (this.allowMultiple) {
            ...
            if (isNonEmptyArray(contentList) && !this.scoped)
                for (let i = 0; i < contentList.length; i++)
                    this.setContent(context, instance, contentList[i]);
    ...
    prepare(context, instance) {
        ...
        if (this.allowMultiple) {
            ...
            if (instance.cache("content", contentId) || shouldUpdate)
    ...
    render(context, instance, key) {
        ...
        if (this.allowMultiple)
            return content.map((x) => x.contentVDOM);
...
export class ContentPlaceholderScope extends PureContainerBase {
    init() {
        super.init();
