...
export class UploadButton extends Field {
    ...
    renderInput(context, instance, key) {
        let { data } = instance;
        return (_jsx(UploadButtonComponent, { instance: instance, children: data.text || this.renderChildren(context, instance) }, key));
    }
}
...
class UploadButtonComponent extends VDOM.Component {
    ...
    render() {
        ...
        return (_jsxs("div", { ref: (el) => {
            ...
            }, className: className, style: data.style, children: [_jsx("div", { className: CSS.element(baseClass, "progress", {
                        done: this.state.progress == 100,
                    }), style: { width: `${this.state.progress}%` } }, "progress"), icon, children, !data.disabled && (_jsx("input", { className: CSS.element(baseClass, "input"), type: "file", title: " ", accept: data.accept, multiple: widget.multiple, tabIndex: data.tabIndex, onChange: this.onFileSelected.bind(this) }, this.state.uploadKey))] }));
    }
    onFileSelected(e) {
            ...
            xhr.upload.onprogress = (event) => {
                if (event.lengthComputable) {
                    ...
                    if (widget.onUploadProgress)
                        instance.invoke("onUploadProgress", event, instance, file, formData);
                }
            };
            xhr.send(formData);
        })
