...
export class NumberField extends Field {
    ...
    renderInput(context, instance, key) {
        return (_jsx(Input, { data: instance.data, instance: instance, label: this.labelPlacement &&
...
class Input extends VDOM.Component {
    ...
    render() {
        ...
        return (_jsxs("div", { className: CSS.expand(data.classNames, CSS.state({
                ...
                error: data.error &&
                    ...
                    }, style: data.inputStyle, disabled: data.disabled, readOnly: data.readOnly, tabIndex: data.tabIndex, placeholder: data.placeholder, ...data.inputAttrs, onMouseMove: (e) => tooltipMouseMove(e, ...getFieldTooltip(this.props.instance)), onMouseLeave: (e) => tooltipMouseLeave(e, ...getFieldTooltip(this.props.instance)), onChange: (e) => this.onChange(e, "change"), onKeyDown: this.onKeyDown.bind(this), onBlur: (e) => this.onBlur(e), onFocus: (e) => this.onFocus(), onClick: stopPropagation }), insideButton, icon, label, help] }));
    }
    ...
    componentDidMount() {
        ...
        if (widget.reactOn.indexOf("wheel") !== -1) {
            this.unsubscribeOnWheel = addEventListenerWithOptions(this.input, "wheel", (e) => {
    ...
    onChange(e, change) {
        ...
        if ((widget.reactOn.indexOf(change) == -1 && !immediate) ||
            data.disabled ||
            data.readOnly)
            return;
        if (immediate)
        ...
        if (inputValue) {
            ...
            if (change == "wheel") {
                e.preventDefault();
                let increment = data.increment != null
                    ? data.increment
