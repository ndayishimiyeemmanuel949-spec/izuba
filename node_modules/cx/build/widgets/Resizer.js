...
export class Resizer extends Widget {
    ...
    render(context, instance, key) {
        let { data } = instance;
        return _jsx(ResizerCmp, { instance: instance, data: data }, key);
    }
}
...
class ResizerCmp extends VDOM.Component {
    ...
    render() {
        ...
        return (_jsx("div", { ref: (el) => {
            ...
            })), style: data.style, onDoubleClick: (e) => {
            ...
            }, onMouseMove: this.startCapture.bind(this), onMouseLeave: this.startCapture.bind(this), children: _jsx("div", { className: CSS.element(baseClass, "handle", { dragged: this.state.dragged }), style: {
    ...
    startCapture(e) {
        ...
        if (this.state.dragged && !this.hasCapture) {
            ...
            captureMouseOrTouch(e, this.onHandleMove.bind(this), this.onDragComplete.bind(this), this.state.initialPosition, widget.horizontal ? "row-resize" : "col-resize");
        }
    }
