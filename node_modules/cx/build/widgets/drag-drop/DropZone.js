...
class DropZoneComponent extends VDOM.Component {
    ...
    render() {
        ...
        return (_jsx("div", { className: CSS.expand(classes), style: { ...data.style, ...this.state.style, ...stateStyle }, ref: (el) => {
                this.el = el;
            }, children: children }));
    }
    componentDidMount() {
    ...
    onDragMeasure(e) {
        ...
        let distance = Math.max(0, rect.left - clientX, clientX - rect.right) +
