...
class DragSourceComponent extends VDOM.Component {
    ...
    render() {
        ...
        if (this.state.dragged) {
            if (data.draggedClass)
                classes.push(data.draggedClass);
        ...
        return (_jsx("div", { id: data.id, ref: this.setRef, className: CSS.expand(classes), style: style, ...eventHandlers, children: children }));
    }
    onMouseDown(e) {
        ddMouseDown(e);
