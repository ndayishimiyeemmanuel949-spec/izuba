...
export class MenuItemInstance extends HtmlElementInstance {
}
export class MenuItem extends HtmlElement {
    ...
    render(context, instance, key) {
        return (_jsx(MenuItemComponent, { instance: instance, data: instance.data, children: instance.data.text ? _jsx("span", { children: instance.data.text }) : this.renderChildren(context, instance) }, key));
    }
    add(element) {
...
class MenuItemComponent extends VDOM.Component {
    ...
    render() {
        ...
        let dropdown = this.state.dropdownOpen && (_jsx(Cx, { widget: this.getDropdown(), options: { name: "submenu" }, parentInstance: instance, subscribe: true }));
        let arrow = data.arrow && _jsx(DropdownIcon, { className: CSS.element(baseClass, "arrow") });
        let icon = null;
        ...
        if (data.icon) {
            icon = (_jsx("div", { className: CSS.element(baseClass, "button"), onClick: (e) => {
                    e.preventDefault();
                    ...
                    if (checkbox)
                        e.stopPropagation();
                }, children: Icon.render(data.icon, { className: CSS.element(baseClass, "icon") }) }));
        }
            ...
            if (widget.onClick) {
                if (data.confirm) {
                    yesNo(data.confirm).then((btn) => {
                        if (btn == "yes")
                            instance.invoke("onClick", null, instance);
                    });
                }
                else
