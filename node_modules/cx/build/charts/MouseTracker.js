...
export class MouseTracker extends BoundedObject {
    ...
    render(context, instance, key) {
        ...
        if (!bounds.valid())
            return null;
        return (_jsxs("g", { className: data.classNames, onMouseMove: (e) => {
                this.handleMouseMove(e, instance);
            }, onMouseLeave: (e) => {
                this.handleMouseLeave(e, instance);
            }, children: [_jsx("rect", { x: bounds.l, y: bounds.t, width: bounds.width(), height: bounds.height(), fill: "transparent", strokeWidth: "0" }), this.renderChildren(context, instance)] }, key));
    }
