...
export class RangeMarker extends BoundedObject {
    ...
    explore(context, instance) {
        ...
        if (this.affectsAxes) {
            if (xAxis && data.x != null)
                xAxis.acknowledge(data.x, 0, 0);
            if (yAxis && data.y != null)
                yAxis.acknowledge(data.y, 0, 0);
        }
    ...
    render(context, instance, key) {
        ...
        return (_jsxs("g", { className: data.classNames, style: data.style, children: [_jsx("path", { d: path, className: CSS.expand(CSS.element(baseClass, "path"), data.lineClass), style: data.lineStyle }), this.renderChildren(context, instance)] }, key));
    }
}
