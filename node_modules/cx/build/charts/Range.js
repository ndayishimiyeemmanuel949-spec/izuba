...
export class Range extends BoundedObject {
    ...
    render(context, instance, key) {
        ...
        if (!data.active)
            return null;
        var { bounds } = data;
        var x1 = Math.min(bounds.l, bounds.r), y1 = Math.min(bounds.t, bounds.b), x2 = Math.max(bounds.l, bounds.r), y2 = Math.max(bounds.t, bounds.b);
        var stateMods = {
            ["color-" + data.colorIndex]: data.colorIndex != null,
        };
        return (_jsxs("g", { className: data.classNames, children: [!this.hidden && (_jsx("rect", { className: this.CSS.element(this.baseClass, "rect", stateMods), style: data.style, x: x1, y: y1, width: x2 - x1, height: y2 - y1, onMouseDown: (e) => this.handleMouseDown(e, instance), onTouchStart: (e) => this.handleMouseDown(e, instance) })), this.renderChildren(context, instance)] }, key));
    }
    ...
    handleMouseDown(e, instance) {
        if (this.draggableX || this.draggableY) {
            ...
            if (svgEl)
                ...
                }, undefined, captureData, e.target.style.cursor);
        }
    }
