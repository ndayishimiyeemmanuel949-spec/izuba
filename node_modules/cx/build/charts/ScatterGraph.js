...
export class ScatterGraph extends Widget {
    ...
    render(context, instance, key) {
        var { data } = instance;
        return (_jsx("g", { className: data.classNames, children: this.renderData(context, instance) }, key));
    }
    renderData(context, instance) {
        ...
        return (isArray(data.data) &&
            data.data.map((p, i) => {
                ...
                var cx = xAxis.map(p[this.xField]), cy = yAxis.map(p[this.yField]), size = this.sizeField ? p[this.sizeField] : data.size;
