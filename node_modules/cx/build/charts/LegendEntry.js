...
export class LegendEntry extends Container {
    ...
    render(context, instance, key) {
        ...
        return (_jsxs("div", { className: data.classNames, style: data.style, onMouseDown: stopPropagation, onClick: (e) => {
                this.handleClick(e, instance);
            }, children: [this.renderShape(instance), content != null && _jsx("div", { children: content })] }, key));
    }
