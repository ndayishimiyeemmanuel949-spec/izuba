...
function createSvgArc(cx, cy, r0 = 0, r, startAngle, endAngle, br = 0, gap = 0) {
    ...
    if (br > 0) {
        ...
        let outerSmallArc1XFrom = cx +
            Math.cos(startAngle) * outerHipDiagonal +
            Math.cos(startAngle + Math.PI / 2) * gap2;
        let outerSmallArc1YFrom = cy -
        ...
        let outerSmallArc2XTo = cx +
            Math.cos(endAngle) * outerHipDiagonal +
            Math.cos(endAngle - Math.PI / 2) * gap2;
        let outerSmallArc2YTo = cy -
