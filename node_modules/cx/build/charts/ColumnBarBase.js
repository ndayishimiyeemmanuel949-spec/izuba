...
export class ColumnBarBase extends StyledContainerBase {
    constructor(config) {
        super(config);
    }
    init() {
    ...
    declareData(...args) {
        ...
        return super.declareData(selection, {
            x: undefined,
            y: undefined,
    ...
    render(context, instance, key) {
        ...
        if (!data.active || !data.valid)
            return null;
        return withHoverSync(key, instance.hoverSync, this.hoverChannel, data.hoverId, ({ hover, onMouseMove, onMouseLeave, key }) => {
            var stateMods = {
                selected: this.selection.isInstanceSelected(instance),
                disabled: data.disabled,
            ...
            return (_jsxs("g", { className: data.classNames, children: [!data.hidden && (_jsx("rect", { className: this.CSS.element(this.baseClass, "rect", stateMods), style: data.style, x: bounds.l, y: bounds.t, width: bounds.width(), height: bounds.height(), rx: data.borderRadius, onMouseMove: (e) => {
