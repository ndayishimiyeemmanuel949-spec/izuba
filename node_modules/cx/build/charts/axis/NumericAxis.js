...
export class NumericAxis extends Axis {
    ...
    explore(context, instance) {
        ...
        instance.calculator.reset(min, max, this.snapToTicks, this.tickDivisions, this.minTickDistance, this.minTickStep, this.minLabelDistance, this.minLabelTickSize, normalized, inverted, lowerDeadZone, upperDeadZone);
    }
    render(context, instance, key) {
        ...
        return (_jsx("g", { className: data.classNames, style: data.style, children: this.renderTicksAndLabels(context, instance, formatter, this.minLabelDistance) }, key));
    }
    static XY() {
        return {
            x: { type: NumericAxis },
