...
export class CategoryAxis extends Axis {
    ...
    render(context, instance, key) {
        ...
        return (_jsx("g", { className: data.classNames, style: data.style, children: this.renderTicksAndLabels(context, instance, labelFormatter, this.minLabelDistance) }, key));
    }
}
...
class CategoryScale {
    ...
    measure(a, b) {
        ...
        if (this.max == null)
            this.max = this.maxValue != null && !isNaN(this.maxValue) ? this.maxValue : 100;
    ...
    findTickSize(minPxDist) {
        for (let tickSize of this.tickSizes)
            if (tickSize * Math.abs(this.factor) >= minPxDist)
                return tickSize;
        return 1;
    }
    getTickSizes() {
