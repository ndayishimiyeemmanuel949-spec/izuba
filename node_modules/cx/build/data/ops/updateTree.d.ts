 ...
 */
export declare function updateTree<T = any, A extends T[] | undefined = T[] | undefined>(array: A, updateCallback: (item: T) => T, itemFilter: ((item: T) => boolean) | null, childrenField: NoInfer<keyof T>, removeFilter?: (item: T) => boolean): A;
//# sourceMappingURL=updateTree.d.ts.map