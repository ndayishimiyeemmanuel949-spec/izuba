 ...
 */
export declare function removeTreeNodes<T = any>(array: T[] | undefined, criteria: (node: T) => boolean, childrenField: NoInfer<keyof T>): T[] | undefined;
//# sourceMappingURL=removeTreeNodes.d.ts.map